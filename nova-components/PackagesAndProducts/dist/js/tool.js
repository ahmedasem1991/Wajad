...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchSubscribedUsersAndItems: function fetchSubscribedUsersAndItems() {
      Nova.request().get('/nova-vendor/subscribed-users-and-items').then(function (response) {
  ...
  created: function created() {
    this.fetchSubscribedUsersAndItems();
  }
});
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v("Subscribed Users And Items")
      ]),
      _vm._v(" "),
      _c("card", {
