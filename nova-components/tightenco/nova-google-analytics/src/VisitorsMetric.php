...
class VisitorsMetric extends Value
{
    ...
    private function visitorsLive()
    {
        $data = app(Analytics::class)
            ->getAnalyticsService()
            ->data_realtime
            ->get('ga:'.env('ANALYTICS_VIEW_ID'), 'rt:activeVisitors')->totalsForAllResults['rt:activeVisitors'];
