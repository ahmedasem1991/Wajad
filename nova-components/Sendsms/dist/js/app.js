...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    Nova.request().get('/nova-vendor/nova-nexmo/balance').then(function (response) {
      _this.balance = _this.roundBalance(response.data.balance);
      _this.auto_reload = response.data.auto_reload;
      _this.loading = false;
    })["catch"](function (error) {
      _this.$toasted.show(error.response.data.error, {
        type: 'error'
      });
    });
  },
  methods: {
    roundBalance: function roundBalance(balance) {
      return Number(Math.round("".concat(balance, "e").concat(this.decimals)) + "e-".concat(this.decimals));
    }
  },
  computed: {
    balanceTextColor: function balanceTextColor() {
      return this.balance > 10 ? 'text-green' : this.balance > 5 ? 'text-yellow' : 'text-red';
    }
  }
});
  ...
  methods: {
    sendSMS: function sendSMS() {
      ...
      if (!this.body.length || !this.from.length || !this.to.length) {
        this.$toasted.show('Please fill all the field', {
          type: 'error'
        });
        return false;
      }

      Nova.request().post('/nova-vendor/nova-nexmo/send-sms', {
        from: this.from,
        to: this.to,
        text: this.body
      }).then(function (response) {
        _this.$toasted.show('SMS sent successfully!', {
          type: 'success'
        });
      })["catch"](function (response) {
        _this.$toasted.show('SMS failed to sent :(', {
          type: 'error'
        });
      });
    }
...
/*!**********************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Card.vue?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************/
...
/*!**************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Card.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("card", { staticClass: "relative px-6 py-4 card-panel" }, [
        _c("div", { staticClass: "flex mb-4" }, [
          _c("h3", { staticClass: "mr-3 text-base text-80 font-bold" }, [
            _vm._v("Nexmo balance")
          ])
        ]),
        _vm._v(" "),
        _c(
        ...
        _c("div", { staticClass: "flex items-center" }, [
          _vm.auto_reload
            ? _c("p", { staticClass: "text-80" }, [
                _vm._v("\n                AutoReload is "),
                _c("span", { staticClass: "text-green" }, [_vm._v("enabled")])
              ])
            : _c("p", { staticClass: "text-80" }, [
                _vm._v("\n                AutoReload is "),
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Send SMS")]),
      _vm._v(" "),
          ...
          _c("div", { staticClass: "flex border-b border-40" }, [
            ...
            _c("div", { staticClass: "w-1/2 px-8 py-6" }, [
              _c("input", {
                ...
                attrs: { id: "send-sms-to", type: "text" },
          ...
          _c("div", { staticClass: "flex border-b border-40" }, [
            ...
            _c("div", { staticClass: "w-1/2 px-8 py-6" }, [
              _c("input", {
                ...
                staticClass:
                  "w-full form-control form-input form-input-bordered",
                attrs: { id: "send-sms-from", type: "text" },
...
Nova.booting(function (Vue, router) {
  Vue.component('nova-nexmo', __webpack_require__(/*! ./components/Card */ "./resources/js/components/Card.vue"));
  router.addRoutes([{
...
module.exports = __webpack_require__(/*! C:\laragon\www\wajad\nova-components\Sendsms\resources\js\app.js */"./resources/js/app.js");
