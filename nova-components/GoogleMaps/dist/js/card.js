...
Nova.booting(function (Vue, router, store) {
    Vue.component('google-maps', __webpack_require__(2));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__google_markerclusterer__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gmaps__ = __webpack_require__(14);
          ...
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              .map(function (location) {
                var marker = new google.maps.Marker(_extends({}, location, { map: map }));
...
var API_KEY = 'AIzaSyD0JHWfRcse1Qm0MqaeAX9vbsbHxE9Cvgk';
var CALLBACK_NAME = 'gmapsCallback';

var initialized = !!window.google;
var resolveInitPromise = void 0;
var rejectInitPromise = void 0;
...
var render = function() {
  ...
  return _c("card", { staticClass: "flex flex-col" }, [
    _c("div", { staticClass: "hello" }, [
      _c("h1", { staticStyle: { margin: "20px" } }, [_vm._v(_vm._s(_vm.msg))])
    ]),
    _vm._v(" "),
    _c("div", {
      staticStyle: { width: "98%", height: "700px", margin: "20px" },
      attrs: { id: "myMap" }
    })
  ])
}
