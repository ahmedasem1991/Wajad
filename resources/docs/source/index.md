...
```bash
curl -X GET \
    -G "http://api.wajad.test/api/items/rem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://api.wajad.test/api/items/rem"
);
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"title":"sit","details":"id","color_id":"enim","brand_id":"voluptatem","model_id":"suscipit","sub_category_id":"ad"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"old_password":"nesciunt","new_password":"laborum"}'
