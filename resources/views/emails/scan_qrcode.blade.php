...
<!-- Notification 1  -->
<div style="display: none" id="element_043909819843247533"></div><!-- End Notification 1 -->
...
<table width="400" border="0" cellpadding="0" cellspacing="0" align="center"
        class="full" bgcolor="#fe5258" object="drag-module-small" style="background: rgb(36,189,239);
        background: linear-gradient(90deg, rgba(36,189,239,1) 0%, rgba(5,155,221,1) 100%);">
    <tr>
        <td width="100%" valign="middle" align="center">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td align="center" height="40" bgcolor="#fe5258"
                                    ...
                                    <p
                                        style="color: rgb(255, 255, 255); text-decoration: none; width: 100%;"><a href="{{$goolemap}}">Show Map</a></p>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="300" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td valign="middle" width="100%"
                        ...
                        class="fullCenter">
                        <!-- <a href="{{$goolemap}}"
                                                style="color: rgb(177, 183, 192);">Show Map</a> -->
...
<table width="352" border="0" cellpadding="0" cellspacing="0" align="center"
    ...
    <tr>
        <td valign="middle" width="100%"
            style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: rgb(142, 145, 151); font-size: 12px; font-weight: 400; line-height: 18px;"
            class="fullCenter">
            <i>By Wajad Development Team</i><br>
             
        </td>
    </tr>
    <tr>
        <td width="100%" height="20" style="font-size: 1px; line-height: 1px;">
            &nbsp;</td>
    </tr>
    <tr>
        <td valign="middle" width="100%"
...
<!-- Notification 3  -->
<div style="display: none" id="element_09012734692078084"></div><!-- End Notification 3 -->

<!-- Notification 4  -->
<div style="display: none" id="element_07834068818483502"></div><!-- End Notification 4 -->

<!-- Notification 5  -->
<div style="display: none" id="element_07226024747360498"></div><!-- End Notification 5 -->

<!-- Notification 6  -->
<div style="display: none" id="element_07811808886472136"></div><!-- End Notification 6 -->
